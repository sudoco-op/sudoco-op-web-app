    ...
    <div className="min-h-screen w-screen bg-(--bg-main) flex font-sans text-(--text-main) overflow-hidden transition-colors duration-300 ">
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative">
        ...
        <div className="flex flex-col gap-5 w-full max-w-sm px-6">
          <Link to="/create-game">
            <button className="group w-full relative flex items-center justify-between p-6 bg-(--primary) hover:bg-(--primary-hover) text-(--text-inverse) transition-all duration-300 rounded-2xl shadow-xl shadow-blue-500/20 active:scale-[0.98]">
